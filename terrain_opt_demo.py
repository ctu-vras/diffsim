...
from data_transforms import parse_csv_traj, parse_csv_control
import os
...
simulator = DiffSim(torch_hm, torch_kf, res, use_renderer=True, device=device)
...
sgd_iters = 2000
heightmap_opt = torch.optim.SGD(torch_hm + torch_kf, lr=0.01)
